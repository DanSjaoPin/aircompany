...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        [Test]
        public void MilitaryPlanesInAirport()
        {
            ...
            Assert.True(hasMilitaryTransportPlane);
        }

        [Test]
        public void FindMaxPlanesWithMaxPassengersCapacity()
        {
            Airport airport = new Airport(planes);
        ...
        public void SortedByMaxLoadCapacity()
        {
            ...
            for (int i = 0; i < planesSortedByMaxLoadCapacity.Count - 1; i++)
            {
                ...
                if (currentPlane.PlaneMaxLoadCapacity > nextPlane.PlaneMaxLoadCapacity)
                {
